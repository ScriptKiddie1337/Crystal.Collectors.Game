...
var startGame = function() {
  ...
  console.log("pink: " + crystal.pink.value + " | white: " + crystal.white.value + " | purple: " + crystal.purple.value + " | yellow: " + crystal.yellow.value);
  console.log("-----------------------------")
...
var checkWin = function() {
  if (currentScore > targetScore) {
    ...
    $("#game-wins").text(winCount);

    startGame();
  }
};

//Grey when I type clickedcrystal but then changes to blue when I type clickedCrystal  WHY?
var addValues = function(clickedCrystal) {
  currentScore += clickedCrystal.value;

  $('#current-score').text(currentScore);

//How does putting the checkwin function work?  Can you explain this function
  checkWin();
